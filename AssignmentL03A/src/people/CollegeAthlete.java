...
/**
 * The CollegeAthlete class represents an athlete.
 *
 * Interfaces for specific types of athletes should extend this interface.
 *
 */
public class CollegeAthlete extends Person implements Athlete {
   ...
   public CollegeAthlete(String firstName, String lastName, int age) {
