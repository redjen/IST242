...
public abstract class BasePanel extends JPanel {
    ...
    public void setHalloween(boolean isHalloween) {
        ...
        if (isHalloween) {
            border = new LineBorder(HALLOWEEN_BORDER_COLOR, 1, true);
            setBorder(border);
            setBackground(HALLOWEEN_BACKGROUND_COLOR);
        } else {
            border = new LineBorder(DEFAULT_BORDER_COLOR, 1, true);
